                ...
                <div className="bg-white rounded-lg shadow-md p-8">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="list-disc pl-6 text-gray-700 mb-4">
                                <li><strong>Free Plan:</strong> Limited content generation with basic features</li>
                                <li><strong>Pro Plan:</strong> Enhanced features and higher generation limits</li>
                                <li><strong>Business Plan:</strong> Advanced features for teams and businesses</li>
                        ...
                        <section className="mb-8">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <p className="text-gray-700 mb-2">
                                    <strong>Legal Inquiries:</strong> legal@thinktapflow.com
                                </p>
                                <p className="text-gray-700 mb-2">
                                    <strong>General Support:</strong> support@thinktapflow.com
                                </p>
                                <p className="text-gray-700">
