        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4 text-gray-700">
              This Privacy Policy describes how ThinkTapFlow ("we," "our," or "us") collects, uses,
              and protects your information when you use our automated content generation SaaS
              application.
            </p>
          ...
          <section className="mb-8">
            ...
            <h3 className="mb-3 text-xl font-semibold text-gray-800">2.1 Account Information</h3>
            ...
            <h3 className="mb-3 text-xl font-semibold text-gray-800">2.3 Usage Analytics</h3>
            <ul className="mb-4 list-disc pl-6 text-gray-700">
          ...
          <section className="mb-8">
            ...
            <h3 className="mb-3 text-xl font-semibold text-gray-800">3.1 Service Provision</h3>
            <ul className="mb-4 list-disc pl-6 text-gray-700">
            ...
            <h3 className="mb-3 text-xl font-semibold text-gray-800">3.2 Platform Improvement</h3>
            <ul className="mb-4 list-disc pl-6 text-gray-700">
          ...
          <section className="mb-8">
            ...
            <div className="rounded-lg bg-blue-50 p-4">
              <h3 className="mb-3 text-xl font-semibold text-gray-800">4.1 Content Processing</h3>
              <ul className="mb-4 list-disc pl-6 text-gray-700">
                ...
                <li>
                  <strong>We do not use your personal content to train public AI models</strong>
                </li>
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-bold text-gray-900">5. Data Storage and Security</h2>

            <h3 className="mb-3 text-xl font-semibold text-gray-800">5.1 Security Measures</h3>
            <div className="rounded-lg bg-green-50 p-4">
              <ul className="list-disc pl-6 text-gray-700">
                <li>
                  <strong>End-to-End Encryption:</strong> All data is encrypted in transit using TLS
                  1.3 and stored securely with AES-256 encryption.
                </li>
                <li>
                  <strong>Access Management:</strong> We implement role-based access controls and
                  multi-factor authentication to ensure only authorized users can access sensitive
                  data.
                </li>
                <li>
                  <strong>Ongoing Security Audits:</strong> Regular vulnerability assessments and
                  penetration testing are conducted to identify and fix potential threats.
                </li>
                <li>
                  <strong>Secure Cloud Infrastructure:</strong> Hosted on trusted cloud providers
                  with compliance to industry standards such as ISO 27001 and SOC 2.
                </li>
              </ul>
            </div>

            <h3 className="mb-3 mt-6 text-xl font-semibold text-gray-800">5.3 Data Retention</h3>
            <ul className="mb-4 list-disc pl-6 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="mb-4 text-2xl font-bold text-gray-900">6. Third-Party Services</h2>

            <h3 className="mb-3 text-xl font-semibold text-gray-800">6.1 Payment Processing</h3>
            <p className="mb-4 text-gray-700">
              <strong>Paddle:</strong> Handles all payment processing and billing. Data shared
              includes billing information and subscription details for payment processing, tax
              compliance, and fraud prevention.
            </p>

            <h3 className="mb-3 text-xl font-semibold text-gray-800">
              6.2 AI and Infrastructure Services
            </h3>
            <ul className="mb-4 list-disc pl-6 text-gray-700">
              <li>
                <strong>OpenAI/Anthropic:</strong> AI model access for content generation
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <h3 className="mb-3 text-xl font-semibold text-gray-800">7.1 Access and Control</h3>
            <ul className="mb-4 list-disc pl-6 text-gray-700">
            ...
            <h3 className="mb-3 text-xl font-semibold text-gray-800">
              7.3 Legal Rights (where applicable)
            </h3>
            <ul className="mb-4 list-disc pl-6 text-gray-700">
