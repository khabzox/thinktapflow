              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="name" value={profile?.full_name || ""} onChange={handleNameChange} />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 sm:col-span-2">
                    ...
                    <Input id="bio" value={profile?.bio || ""} onChange={handleBioChange} />
                  </div>
                </div>
              </CardContent>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <Alert>
                      ...
                      <AlertDescription>
                        Two-factor authentication will be available soon. This feature is currently
                        under development.
                      </AlertDescription>
                    </Alert>
                    <div className="text-sm text-muted-foreground">
              ...
              <CardContent className="space-y-6">
                <Alert className="border-yellow-200 bg-yellow-50">
                  ...
                  <AlertDescription className="text-yellow-600">
                    This page is under construction. Enhanced billing features will be implemented
                    soon.
                  </AlertDescription>
                </Alert>
            ...
            <Card>
              ...
              <CardContent>
                <Alert className="mb-6 border-yellow-200 bg-yellow-50">
                  <AlertCircle className="h-4 w-4 text-yellow-600" />
                  <AlertDescription className="text-yellow-600">
                    Content library features will be implemented here. More integrations coming
                    soon.
                  </AlertDescription>
                </Alert>
