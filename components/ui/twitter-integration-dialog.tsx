        ...
        <ScrollArea className="max-h-[60vh]">
          <div className="space-y-6 pr-6">
            ...
            <Alert>
              ...
              <AlertDescription>Standard rate limit: 300 tweets per hour</AlertDescription>
            </Alert>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Plan tweets up to 18 months ahead
                    </p>
                  </div>
                  <Switch
            ...
            <div className="space-y-2 rounded-lg border p-4">
              ...
              <p className="text-sm text-muted-foreground">
                Access comprehensive analytics including engagement rates, impressions, follower
                growth, and best performing content.
              </p>
            </div>
          </div>
        </ScrollArea>
