                    ...
                    <div className="space-y-6 pr-6">
                            ...
                            <div className="ml-7 space-y-4">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Post during peak engagement times</p>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Optimize for international reach</p>
                                    </div>
                                    <Switch
                        ...
                        <div className="rounded-lg border p-4 space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Maximize your LinkedIn presence with data-driven insights, industry-specific content strategies, 
                                and engagement analytics to grow your professional network.
                            </p>
                        </div>
                    </div>
                </ScrollArea>
