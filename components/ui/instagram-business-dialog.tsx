            ...
            <DialogContent className="sm:max-w-[600px]">
                ...
                <ScrollArea className="max-h-[60vh]">
                    <div className="space-y-6 pr-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <RadioGroup
                                value={accountType}
                                onValueChange={(value: "business" | "creator" | "personal") => setAccountType(value)}
                            ...
                            <div className="ml-7 space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Create engaging short-form content</p>
                                    </div>
                                    <Switch
                            ...
                            <div className="ml-7 space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-muted-foreground">Automatically post approved content</p>
                                    </div>
                                    <Switch
                ...
                <DialogFooter className="flex sm:justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button
                            onClick={onConnect}
                            disabled={accountType === "personal" || !Object.values(contentManagement).some(Boolean)}
