...
export const aiConfig = {
  ...
  prompts: {
    system: {
      default: 'You are a professional content creator specializing in social media marketing. Create engaging, authentic content that resonates with the target audience.',
      marketing: 'You are a marketing expert. Create compelling content that drives engagement and conversions while maintaining brand authenticity.',
      casual: 'You are a friendly content creator. Write in a conversational, approachable tone that feels natural and engaging.',
      professional: 'You are a business communication expert. Create polished, professional content suitable for corporate environments.'
    },
    ...
    formats: {
      ...
      video: 'Create a {platform} video script about {topic}. Include engaging hooks and clear structure.'
    }
  },
