...
export const defaultMetadata: Metadata = {
    ...
    description: "ThinkTapFlow is a modern SaaS platform for automated, AI-powered content generation across multiple social media channels. Built with Next.js 14, Supabase, and Google Generative AI.",
